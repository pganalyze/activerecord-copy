...
describe 'integration' do
  it 'supports all common fields' do
    ...
    MyModel.copy_from_client(columns) do |csv|
      1000.times do
        csv << ['42', 9_223_372_036_854_775_807, true, t1, t1, t1, t1, 4242.42, 4242.42, 42, 'this is some text',
                factory.point(1, 2), { a: 1 }, { a: 1 }, inet, cidr, mac_addr]
        csv << ['1', -9_223_372_036_854_775_808, false, t2, t2, t2, t2, -4242.42, 4242.42, -42, utf8_stress_test,
                polygon, [{ a: 1 }], [{ a: 1 }], inet.to_s, cidr.to_s, '32-01-16-6D:05-EF']
      end
    end
    ...
    expect(MyModel.second.attributes.symbolize_keys).to(
      include(
        binary: '1',
        bigint: -9_223_372_036_854_775_808,
        decimal: -4242.42,
        boolean: false,
